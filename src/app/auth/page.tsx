...
export default function AuthPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-4 mesh-bg">
      <div className="w-full max-w-[420px]">
        {/* Close / Back */}
        <div className="flex justify-end mb-2">
          <Link href="/" className="p-2 rounded-lg transition-colors btn-ghost">
            <X size={20} />
          </Link>
        </div>

        <div className="card-chamber overflow-hidden animate-scale-in">
          {/* Header */}
          ...
          <div className="p-7 space-y-5">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-3 font-medium" style={{ background: 'var(--bg-elevated)', color: 'var(--text-tertiary)' }}>OR</span>
              </div>
            </div>
